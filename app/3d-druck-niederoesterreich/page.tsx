...
export const metadata: Metadata = {
  ...
  description: 'Drucken lassen aus OÖ mit Direktlieferung St. Pölten, Krems, Wiener Neustadt. Für Industriekunden im Wien-Umland.',
  alternates: {
...
const REGION_LD = regionalLocalBusinessSchema({
  ...
  url: 'https://www.ek-druck.at/3d-druck-niederoesterreich',
  description: '3D-Druck-Service für Kunden in Niederösterreich. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Kleinserien. Persönliche Antwort in 6h.',
})
