...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/messemodelle/express`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.8 },
    ...
    // AT-Architektur-Regionalseiten (Audit B2, 22.09.: waren indexierbar, aber in keiner Sitemap)
    { url: `${SITE}/architekturmodelle/wien`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/niederoesterreich`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/oberoesterreich`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/steiermark`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/kaernten`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/salzburg`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/tirol`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/vorarlberg`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/burgenland`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/linz`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/wels`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/graz`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/klagenfurt`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/villach`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/st-poelten`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/innsbruck`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/dornbirn`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE}/architekturmodelle/wettbewerbsmodell`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE}/architekturmodelle/gelaendemodell`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.8 },
  ...
  const ratgeberPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/studenten`, lastModified: buildDate, changeFrequency: 'monthly', priority: 0.7 },
