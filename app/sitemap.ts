...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/firmenkunden`, lastModified: buildDate, changeFrequency: 'weekly', priority: 0.85 },    { url: `${SITE}/kostenrechner`, lastModified: buildDate, changeFrequency: 'weekly', priority: 0.9 },
