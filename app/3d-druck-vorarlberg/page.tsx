...
const REGION_LD = regionalLocalBusinessSchema({
  region: 'Vorarlberg',
  url: 'https://www.ek-druck.at/3d-druck-vorarlberg',
  description: '3D-Druck-Service für Kunden in Vorarlberg. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Mehrfachfertigung. Persönliche Antwort in 6h. Ab €20.',
})
