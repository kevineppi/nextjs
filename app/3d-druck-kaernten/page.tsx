...
const REGION_LD = regionalLocalBusinessSchema({
  region: 'Kärnten',
  url: 'https://www.ek-druck.at/3d-druck-kaernten',
  description: '3D-Druck-Service für Kunden in Kärnten. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Mehrfachfertigung. Persönliche Antwort in 6h. Ab €20.',
})
