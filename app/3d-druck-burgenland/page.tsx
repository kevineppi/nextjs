...
export const metadata: Metadata = {
  ...
  description: '3D-Druck mit ÖPOST-Versand nach Eisenstadt, Neusiedl, Mattersburg. Für Weinbau-Modelle, Industrie-Modelle, Tourismus. Ab €20.',
  alternates: {
...
const REGION_LD = regionalLocalBusinessSchema({
  region: 'Burgenland',
  url: 'https://www.ek-druck.at/3d-druck-burgenland',
  description: '3D-Druck-Service für Kunden in Burgenland. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Mehrfachfertigung. Persönliche Antwort in 6h. Ab €20.',
})
