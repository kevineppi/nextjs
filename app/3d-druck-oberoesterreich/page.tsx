...
const REGION_LD = regionalLocalBusinessSchema({
  ...
  url: 'https://www.ek-druck.at/3d-druck-oberoesterreich',
  description: '3D-Druck-Service für Kunden in Oberösterreich. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Mehrfachfertigung. Persönliche Antwort in 6h. Ab €20.',
})
