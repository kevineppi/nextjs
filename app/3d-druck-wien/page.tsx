...
const REGION_LD = regionalLocalBusinessSchema({
  region: 'Wien',
  url: 'https://www.ek-druck.at/3d-druck-wien',
  description: '3D-Druck-Service für Kunden in Wien. Express-Versand 24h aus Gunskirchen, OÖ. Architekturmodelle, Messemodelle, Prototypen, Mehrfachfertigung. Persönliche Antwort in 6h. Ab €20.',
})
