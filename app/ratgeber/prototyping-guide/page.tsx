...
export const metadata: Metadata = {
  title: 'Rapid Prototyping: vom CAD zum Prototyp [Guide]',
  description: 'Komplett-Guide für Konstrukteure: Verfahrenswahl, Detailgenauigkeit, Material, CAD-Export. Mit Iterations-Checkliste und typischen Fehlern.',
  alternates: {
