...
const branche = getBranche('schiffbau')!
...
export const metadata: Metadata = {
  ...
  alternates: buildDachAlternates('/branchen/schiffbau'),
  openGraph: {
    title: branche.metaTitle,
    description: branche.metaDescription,
    url: 'https://www.ek-druck.at/branchen/schiffbau',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ekdruck · Schiffbau-Messemodelle aus dem 3D-Druck',
      },
    ],
  },
  twitter: {
...
const SERVICE_LD = serviceSchema({
  serviceType: `3D-Druck für Schiffbau`,
  description: branche.metaDescription,
  url: 'https://www.ek-druck.at/branchen/schiffbau',
  lowPrice: '20',
  highPrice: '8000',
...
const BREADCRUMB_LD = breadcrumbSchema([
  ...
  { name: branche.h1, url: '/branchen/schiffbau' },
])
