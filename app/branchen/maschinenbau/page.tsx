...
const branche = getBranche('maschinenbau')!
...
export const metadata: Metadata = {
  ...
  alternates: buildDachAlternates('/branchen/maschinenbau'),
  openGraph: {
    title: branche.metaTitle,
    description: branche.metaDescription,
    url: 'https://www.ek-druck.at/branchen/maschinenbau',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ekdruck · Maschinenbau-Messemodelle aus dem 3D-Druck',
      },
    ],
  },
  twitter: {
...
const SERVICE_LD = serviceSchema({
  serviceType: `3D-Druck für Maschinenbau`,
  description: branche.metaDescription,
  url: 'https://www.ek-druck.at/branchen/maschinenbau',
  lowPrice: '20',
  highPrice: '8000',
...
const BREADCRUMB_LD = breadcrumbSchema([
  ...
  { name: branche.h1, url: '/branchen/maschinenbau' },
])
