...
const Einzelanfertigungen = () => {
  return (
    <>
      ...
      <StickyCTA context="Einzelanfertigung" />      <section id="kontakt" className="scroll-mt-20"><Contact /></section>
