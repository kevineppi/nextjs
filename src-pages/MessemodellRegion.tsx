...
const MessemodellRegion = () => {
  ...
  // Whitelist: nur Slugs für die echte /messemodelle/{slug}/page.tsx existiert.
  // Sonst generieren nearbyRegions blind 404-Links (siehe Ahrefs-Audit 2026-06-04).
            ...
            <div className="container mx-auto px-4 relative">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <AnimatedSection animation="slide-up" delay={200} className="grid grid-cols-2 gap-4">
                  <Card className="col-span-2 bg-primary text-primary-foreground border-0 shadow-lg overflow-hidden relative"><CardContent className="p-8 text-center relative"><Sparkles className="w-8 h-8 mx-auto mb-3 opacity-80" /><div className="text-5xl font-bold mb-2">5,0 ★</div><div className="text-primary-foreground/80">aus 35 Google-Bewertungen</div></CardContent></Card>
                  ...
                  <Card className="border border-border/50 shadow-md bg-card"><CardContent className="p-6 text-center"><div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3"><CheckCircle className="w-6 h-6 text-primary" /></div><div className="text-3xl font-bold text-primary mb-1">24-48h</div><div className="text-sm text-muted-foreground">Express-Fertigung</div></CardContent></Card>
                </AnimatedSection>
              </div>
            </div>
          </section>
