          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection animation="fade-in">
              ...
              <div className="space-y-6 text-base leading-[1.85] text-foreground/85">
                <p>Ein <strong>Messemodell express drucken zu lassen</strong> heißt, eine harte Deadline noch zu retten. Wenn der Messetermin steht und das Modell fehlt, ist der 3D-Druck oft der schnellste Weg: Angebot in 6 Stunden, Fertigung in 24 bis 48 Stunden. Wir fertigen Eye-Catcher und maßstabsgetreue Anschauungsmodelle für den Messestand, auch kurzfristig und ab einem einzelnen Stück.</p>
