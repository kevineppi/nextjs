            ...
            <AnimatedSection animation="fade-in">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-end">
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  ...
                  Wir fertigen maßstabsgetreue Messemodelle und Exponate, Ausstellungs- und
            ...
            <AnimatedSection animation="fade-in">
              ...
              <div className="space-y-8 text-base leading-[1.85] text-foreground/85">
                ...
                <div className="rounded-3xl bg-muted/50 border border-border/50 p-8 md:p-10 not-prose">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Von unserem Standort in Gunskirchen (Oberösterreich) beliefern wir <strong className="text-foreground">alle Messen in Österreich, Deutschland und der Schweiz</strong>. Persönliche Lieferung in <strong className="text-foreground">Wien</strong>, <strong className="text-foreground">Linz/Wels</strong> und <strong className="text-foreground">Salzburg</strong>. Versand nach <strong className="text-foreground">München</strong>, <strong className="text-foreground">Nürnberg</strong>, <strong className="text-foreground">Stuttgart</strong>, <strong className="text-foreground">Berlin</strong> und <strong className="text-foreground">Hamburg</strong> in 3–5 Werktagen. Schweiz (<strong className="text-foreground">Basel</strong>, <strong className="text-foreground">Zürich</strong>, <strong className="text-foreground">Bern</strong>, <strong className="text-foreground">St. Gallen</strong>) inkl. Zolldokumentation.</p>
                </div>
