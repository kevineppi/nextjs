...
const messeKalender = [
  { name: "IFAT", ort: "München", datum: "Mai 2026", branche: "Umwelttechnik", bestellStart: "Mär 2026", status: "bald" as const, link: "/messemodelle" },
  { name: "Automechanika", ort: "Frankfurt", datum: "Sep 2026", branche: "Automotive", bestellStart: "Jul 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "Welser Messe", ort: "Wels", datum: "Sep 2026", branche: "Industrie", bestellStart: "Jul 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "OLMA", ort: "St. Gallen 🇨🇭", datum: "Okt 2026", branche: "Landwirtschaft", bestellStart: "Aug 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "MEDICA", ort: "Düsseldorf", datum: "Nov 2026", branche: "Medizintechnik", bestellStart: "Sep 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "SPS", ort: "Nürnberg", datum: "Nov 2026", branche: "Automation", bestellStart: "Sep 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "BAUEN & WOHNEN", ort: "Wien", datum: "Nov 2026", branche: "Bau & Immobilien", bestellStart: "Sep 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "BAU", ort: "München", datum: "Jan 2027", branche: "Bau & Architektur", bestellStart: "Nov 2026", status: "offen" as const, link: "/messemodelle" },
  { name: "Hannover Messe", ort: "Hannover", datum: "Apr 2027", branche: "Industrie", bestellStart: "Feb 2027", status: "offen" as const, link: "/messemodelle" },
];
            ...
            <AnimatedSection animation="fade-in">
              ...
              <div className="space-y-8 text-base leading-[1.85] text-foreground/85">
                ...
                <div className="rounded-3xl bg-muted/50 border border-border/50 p-8 md:p-10 not-prose">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Von unserem Standort in Gunskirchen (Oberösterreich) beliefern wir <strong className="text-foreground">alle Messen in Österreich, Deutschland und der Schweiz</strong>. Persönliche Lieferung in <Link href="/messemodelle" className="text-primary hover:underline">Wien</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Linz/Wels</Link> und <Link href="/messemodelle" className="text-primary hover:underline">Salzburg</Link>. Versand nach <Link href="/messemodelle" className="text-primary hover:underline">München</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Nürnberg</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Stuttgart</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Berlin</Link> und <Link href="/messemodelle" className="text-primary hover:underline">Hamburg</Link> in 3–5 Werktagen. Schweiz (<Link href="/messemodelle" className="text-primary hover:underline">Basel</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Zürich</Link>, <Link href="/messemodelle" className="text-primary hover:underline">Bern</Link>, <Link href="/messemodelle" className="text-primary hover:underline">St. Gallen</Link>) inkl. Zolldokumentation.</p>
                </div>
