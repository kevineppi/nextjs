            ...
            <AnimatedSection animation="fade-in">
              ...
              <div className="space-y-8 text-base leading-[1.85] text-foreground/85">
                ...
                <div className="rounded-3xl bg-primary/[0.03] border-2 border-primary/20 p-8 md:p-10 not-prose">
                  <h3 className="font-bold text-xl mb-3 text-foreground">Wer macht Messemodelle und Eye-Catcher in Österreich?</h3>
                  <p className="text-muted-foreground leading-relaxed">ekdruck aus Gunskirchen in Oberösterreich fertigt Messemodelle, Ausstellungsmodelle und Eye-Catcher aus dem 3D-Druck für Aussteller in ganz DACH. Das verbindliche Festpreis-Angebot kommt in 6 Stunden, die Express-Fertigung in 24 bis 48 Stunden, ab einem einzelnen Stück. Bewertung: 5,0 von 5 Sternen bei Google.</p>
                </div>
                ...
                <div>
                  ...
                  <p>Ein Messemodell für eine einzelne <strong>Industriemesse</strong> wie die SMART Automation Linz, die Intertool Wien oder die Hannover Messe ist der Klassiker, aber viele Aussteller verwenden das Modell danach weiter. Für <strong>Roadshows mit mehreren Stationen</strong> drucken wir aus widerstandsfähigerem Material (PETG-CF statt PLA), liefern stabile Transport-Boxen mit Schaumstoff-Einlagen und drucken bei Bedarf schnell nach: wenn nach Stadt 4 ein Detail bricht, ist innerhalb von 48h ein neues da. Für <strong>permanente Showrooms</strong> verwenden wir UV-stabiles ASA mit RAL-Lackierung, damit das Modell auch nach drei Jahren Sonnenlicht noch wie am ersten Tag aussieht. Dieselbe Modell-Datei, drei verschiedene Material-Spezifikationen, je nach Einsatz-Profil.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
