            ...
            <div className="container mx-auto px-4 relative">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <AnimatedSection animation="slide-up" delay={200} className="grid grid-cols-2 gap-4">
                  <Card className="col-span-2 bg-primary text-primary-foreground border-0 shadow-lg overflow-hidden relative"><CardContent className="p-8 text-center relative"><Cpu className="w-8 h-8 mx-auto mb-3 opacity-80" /><div className="text-5xl font-bold mb-2">5,0 ★</div><div className="text-primary-foreground/80">aus 35 Google-Bewertungen</div></CardContent></Card>
