...
const branchenUseCases = [
  ...
  { icon: FlaskConical, branche: "Medizintechnik & Forschung", titel: "Vertriebs- und Demonstrationsmodelle", text: "Schaumodelle für Vertrieb, Messe und Training, anatomische Anschauungsmodelle, ergonomische Studien. Bei Bedarf feine SLA-Resin-Modelle für höchste Detailtiefe. NDA-fähige Projektabwicklung, diskrete Bearbeitung vertraulicher Entwicklungsprojekte.", beispiel: "Trainingsmodell für Chirurgen: anatomisch korrektes 1:1-Modell mit aufklappbarer Struktur" },
