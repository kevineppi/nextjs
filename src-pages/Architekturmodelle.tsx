  ...
  const architectPainPoints = [
    {
      ...
      solution: "Wir liefern in 3–5 Werktagen, Express 24h",
      icon: Clock
    },
    {
  ...
  const useCases = [
    {
      ...
      description: "Jedes dritte Modell, das wir für Architekten fertigen, ist ein Wettbewerbsmodell. Deadlines sind heilig – deshalb garantieren wir Express 24h für Wettbewerbsabgaben.",
      details: [
    ...
    <>
      ...
      <main className="min-h-screen bg-background">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-4 leading-relaxed max-w-xl">
                  ...
                  Express 24h für Wettbewerbsabgaben. Bis zu 80% günstiger als traditioneller Modellbau.
                </p>
        ...
        <QuickContactBar
          ...
          subtitle="Express 24h möglich. Wir verstehen ArchiCAD, Revit, SketchUp – kostenlose Datei-Prüfung vor dem Auftrag."
        />
