...
const branchen = [
  ...
  },
  {
    ...
    text: "Architekturschulen, Tourismusbüros, Stadtmuseen, Heimatmuseen: wir fertigen Anschauungsmodelle für Lehre und kulturelle Vermittlung. Robust genug für Schüler-Hände, detailgetreu genug für Fach-Audiences. Auf Wunsch mit haptischen Höhenlinien für inklusive Vermittlung.",
    typisch: "Lehrmodelle, Museums-Exponate, Touristenmodelle",
  },
];

const faqs = [
  { question: "Was kostet ein Architekturmodell aus dem 3D-Druck?", answer: "Einfamilienhaus 1:100: ab €280. Mehrfamilienhaus 1:200: ab €420. Quartiersmodell 1:500: ab €780. Stadtmodell 1:1000: ab €1.890. Detailmodelle 1:50 (Innenraum / Möbliert): ab €450. Alle Preistreiber im Detail: Ratgeber 'Architekturmodell Kosten' unter ek-druck.at/ratgeber/architekturmodell-kosten. Sie erhalten innerhalb von 6 Stunden ein verbindliches Festpreisangebot – kostenlos und unverbindlich, inklusive Materialempfehlung und Lieferdatum." },
  ...
  { question: "Können Sie auch sehr große Modelle drucken?", answer: "Ja. Einzelteile bis 350 × 350 × 350 mm in einem Stück, größere Modelle durch segmentierten Druck mit unsichtbaren Stoßkanten segmentiert bis 2 m Gesamtgröße. Wir haben Modelle bis 1,5 × 1,2 m gefertigt – die Segmentierung erfolgt entlang von Gebäudefugen oder Straßenverläufen, sodass sie auf dem fertigen Modell nicht sichtbar ist." },
  ...
  { question: "Wie steht es um die Maßstabs-Genauigkeit?", answer: "Wir halten uns exakt an die vorgegebenen Außenmaße, gerade bei Wettbewerbsabgaben mit vorgeschriebener Modellgröße. FDM-Druck liefert saubere Kanten und eine gleichmäßige Oberfläche, SLA-Druck für Detailmodelle eine noch feinere Detailtreue. Vor dem Versand prüfen wir jedes Modell und dokumentieren die fertigen Maße auf Wunsch." },
  ...
  <>
    ...
    <main className="min-h-screen bg-background pt-28 md:pt-32">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        {/* Architektur: Bauplan-Grid */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0" style={{backgroundImage:'linear-gradient(hsl(var(--border)/0.4) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--border)/0.4) 1px, transparent 1px)',backgroundSize:'48px 48px'}} />
          <div className="absolute inset-0" style={{backgroundImage:'linear-gradient(hsl(var(--border)/0.2) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--border)/0.2) 1px, transparent 1px)',backgroundSize:'12px 12px'}} />
          <div className="absolute top-[15%] right-[5%] w-[500px] h-[500px] rounded-full bg-primary/[0.05] blur-[110px]" />
          <div className="absolute bottom-[10%] left-[10%] w-[400px] h-[400px] rounded-full bg-primary/[0.03] blur-[100px]" />
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 border-t-2 border-border">
              ...
              <div className="relative py-8 md:py-10 px-2 md:px-6 group border-t md:border-t-0 md:border-l border-border">
                ...
                <div className="flex flex-wrap items-baseline gap-x-2 mt-3">
                  ...
                  <p className="text-[10px] text-muted-foreground">versichert · Standard 3-5 Werktage</p>
                </div>
              </div>
