...
const faqs = [
  ...
  { question: "Wie steht es um die Maßstabs-Genauigkeit?", answer: "Wir halten uns exakt an die vorgegebenen Außenmaße, gerade bei Wettbewerbsabgaben mit vorgeschriebener Modellgröße. FDM-Druck liefert saubere Kanten und eine gleichmäßige Oberfläche, SLA-Druck (über unseren Partner gefertigt) für Detailmodelle eine noch feinere Detailtreue. Vor dem Versand prüfen wir jedes Modell und dokumentieren die fertigen Maße auf Wunsch." },
