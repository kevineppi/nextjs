    ...
    <section ref={sectionRef} className="relative min-h-[100svh] flex flex-col justify-end bg-background overflow-hidden pt-24">
      ...
      <div className="relative z-10 container mx-auto px-4 pb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div style={t(0.2)}>
            <h1 className="font-display text-[clamp(3rem,9vw,8.5rem)] font-bold leading-[1] tracking-[-0.05em] mb-4">
              ...
              <span className="block text-gradient mt-2 md:mt-4 text-[clamp(2.5rem,7.5vw,7rem)] pt-[0.2em] leading-[1.1]">
                {line2.displayed}
          ...
          <div style={t(0.4)} className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mt-8 mb-12">
            <div className="max-w-md">
              <p className="text-muted-foreground text-base leading-relaxed">
                Österreichs Spezialist für{" "}
                <span className="text-primary font-semibold">Architektur- &amp; Messemodelle</span>{" "}
                aus dem 3D-Druck.
