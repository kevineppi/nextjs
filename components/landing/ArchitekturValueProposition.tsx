...
interface ArchitekturValuePropositionProps {
  regionName: string;
}

const ArchitekturValueProposition = ({ regionName }: ArchitekturValuePropositionProps) => {
  const comparisons = [
    {
      metric: "Kosten",
      traditional: "€500-2.000+",
      printed: "Ab €20-200",
      advantage: "Bis 80% günstiger",
      icon: Banknote
    },
    {
      metric: "Lieferzeit",
      traditional: "2-4 Wochen",
      printed: "3-5 Werktage",
        ...
        <AnimatedSection animation="fade-in" className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Der entscheidende Vorteil für Architekten in {regionName}
            </p>
          </div>
...
export default ArchitekturValueProposition;
