...
const steps = [
  ...
  { num: "03", title: "Fertigung & Qualitätskontrolle", time: "1–14 Tage", icon: Wrench, desc: "FDM und SLA starten sofort nach Auftragsbestätigung in unserer Werkstatt. Statusupdates und auf Wunsch Druckfotos zur laufenden Qualitätskontrolle." },
...
const checklist = [
  ...
  { item: "Verfahren-Empfehlung?", sub: "FDM oder SLA" },
