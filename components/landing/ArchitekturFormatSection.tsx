...
const services = [
  ...
  },
  {
    ...
    text: "Wir behandeln IFC-Daten korrekt: Geschosse, Wände, Fenster, Türen behalten ihre Klassenzuordnung. Auf Wunsch farbliche Differenzierung nach Geschoss oder Objektkategorie im fertigen Modell.",
  },
];
