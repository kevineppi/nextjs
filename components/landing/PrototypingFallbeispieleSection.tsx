...
const fallbeispiele = [
  {
    ...
    loesung: "Fünf Design-Varianten aus Carbon-PA in 14 Tagen. Jede Variante in der Hand geprüft, in Form und Haptik optimiert, neu gedruckt. Die finale Version ging direkt in Mehrfachfertigung: 12 Anschauungsmuster fürs Vertriebsteam.",
    ergebnis: [
      { label: "Iterationen", value: "5×" },
      { label: "Gesamtdauer", value: "14 Tage" },
      { label: "Kostenersparnis", value: "€6.200" },
      { label: "Material", value: "Carbon-PA" },
    ],
