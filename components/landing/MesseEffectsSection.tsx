...
const effects = [
  { num: "01", title: "Der Stopper-Effekt", text: "Besucher laufen an den meisten Ständen vorbei. Ein physisches Modell unterbricht den Gang – das Auge bleibt hängen, die Füße folgen. Kein Rollup der Welt kann das.", stat: "Stopper", statLabel: "das Auge bleibt am Objekt hängen" },
  { num: "02", title: "Der Anfass-Reflex", text: "Menschen sind hardwired zum Greifen. Wer ein Modell anfasst, investiert emotional. Die Hemmschwelle für ein Gespräch sinkt auf Null – der Besucher stellt die erste Frage.", stat: "Haptik", statLabel: "das Gespräch beginnt von selbst" },
  { num: "03", title: "Der Anker-Effekt", text: "Ihr Modell bleibt im Kopf. Wenn der Besucher 3 Tage später 200 Visitenkarten durchgeht, erinnert er sich an \"den Stand mit dem Modell\" – nicht an \"den mit dem Rollup\".", stat: "Anker", statLabel: "Ihr Stand bleibt im Kopf" },
];
