...
const alternatives = [
  {
    ...
    priceSub: "pro Stück",
    items: [
      { text: "Keine Haptik", status: "no" },
      { text: "Wird übersehen", status: "no" },
      { text: "Günstig", status: "yes" },
      { text: "Kein Gesprächsstarter", status: "no" },
      { text: "2D Darstellung", status: "no" },
    ],
  },
  {
    name: "Monitor / Screen",
    ...
    sub: "Digital, visuell",
    price: "€1–5k",
    priceSub: "Miete + Content",
    items: [
      { text: "Keine Haptik", status: "no" },
      { text: "Animiert, aber flach", status: "mid" },
      { text: "Mittleres Budget", status: "mid" },
      { text: "Bedingt interaktiv", status: "mid" },
      { text: "2D Darstellung", status: "no" },
    ],
  },
  {
    name: "Handmodellbau",
    icon: "🏗",
    sub: "Klassisch, hochwertig",
    price: "€3–15k",
    priceSub: "pro Modell",
    items: [
      { text: "Exzellente Haptik", status: "yes" },
      { text: "Blickfang", status: "yes" },
      { text: "Sehr teuer", status: "no" },
      { text: "Gesprächsstarter", status: "yes" },
      { text: "3–6 Wochen Vorlauf", status: "mid" },
    ],
  },
];

const winner = {
  name: "3D-Druck Exponat",
  icon: "🎯",
  sub: "ekdruck · Made in Austria",
  price: "ab €30",
  priceSub: "Express 24h · Festpreis",
  items: [
    { text: "Haptisch & greifbar", status: "yes" },
    { text: "Absoluter Eyecatcher", status: "yes" },
    { text: "60–80% günstiger", status: "yes" },
    { text: "Gesprächsmagnet", status: "yes" },
...
export default MesseComparisonSection;
