...
const messemodelle: ServiceSeoContent = {
  ...
  longTailBody: {
    ...
    paragraphs: [
      ...
      'Express-Messemodelle in 24-48 Stunden sind möglich, wenn die Voraussetzungen passen: CAD muss druckreif sein (keine Geometrie-Korrekturen mehr nötig), Material muss verfügbar sein (keine Sonder-Filamente bestellen), und das Modell darf nicht zu groß sein (Express funktioniert bis ca. 40-50 cm Maximalkante). Bei Express-Messemodellen wird ein Aufschlag von 50% auf den Standardpreis fällig. Bei Standard-Lead-Time von 3-4 Wochen ist der Express-Aufpreis vermeidbar. Wer schon 6-8 Wochen vor der Messe anfragt, bekommt zusätzlich die Möglichkeit für Veredelungs-Optionen wie Aceton-Glättung oder mehrfarbige Profi-Lackierung.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Standard-Lead-Time 2-6 Wochen, abhängig von Größe und Komplexität. Express in 24-48 Stunden gegen 50% Aufpreis möglich. Bei sehr komplexen segmentierten Großmodellen (>1m, viele Sektionen) kann die Lead-Time bis zu 8 Wochen betragen. Empfehlung: 6-8 Wochen Vorlauf einplanen für entspannte Veredelungs-Optionen.',
    },
    {
...
const architekturmodelle: ServiceSeoContent = {
  ...
  longTailBody: {
    ...
    paragraphs: [
      ...
      'Wettbewerbsmodell drucken lassen ist die häufigste Anfrage von Architekturbüros bei ek-druck. Ein typisches Wettbewerbsmodell für eine Wohnbau-Abgabe im Maßstab 1:200 mit Hauptgebäude und 2-3 Umgebungsblöcken kostet zwischen €600 und €1.800. Standard sind 3 bis 5 Werktage ab Datenfreigabe, Express-Wettbewerbsmodelle in 24 bis 48 Stunden sind gegen 50% Aufpreis machbar. Häufig kombiniert mit Sockel aus Holz oder MDF, den wir auf Wunsch maßgenau zuschneiden lassen.',
      'Stadtmodell drucken im großen Maßstab (60×80cm bis 120×80cm) ist die anspruchsvollste Kategorie. Hier planen wir Segmentierungen entlang natürlicher Straßenführungen, sodass die Stoßstellen optisch unsichtbar bleiben. Hauptobjekt der Visualisierung wird in Kontrast-Lackierung (typisch weiß) gegen die umliegende Bestandsbebauung (matt-grau, "Beton-Look") gedruckt · das macht die visuelle Hierarchie sofort lesbar. Stadtmodelle für Wiener Bauherrenprojekte, Linzer Stadtentwicklung oder Salzburger Sanierungsprojekte sind regelmäßige Aufträge.',
      'Die meisten Architekturbüros bestellen Modelle zwischen €400 und €3.500 · mit Umgebung, Lackierung und Sockel, je nach Maßstab und Umgriff. Eine detaillierte Aufschlüsselung der Preise und Preistreiber steht im Ratgeber unter /ratgeber/architekturmodell-kosten. Architekturmodell-Flatrate für Architekturbüros mit regelmäßigem Bedarf ab €490 pro Monat · beinhaltet ein freies Modell-Kontingent plus garantierte Lead-Time. Details unter /architekturmodelle-abo.',
    ],
  },
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'Express 5-7 Werktage gegen 50% Aufpreis machbar · falls Geometrie nicht zu komplex ist und Lackierungs-Wunsch sich auf 1-2 Farben begrenzt. Bei knapp zur Wettbewerbs-Frist: rufen Sie an unter +43 676 5517197, ich prüfe Kapazität sofort.',
    },
    {
...
const prototyping: ServiceSeoContent = {
  ...
  longTailBody: {
    ...
    paragraphs: [
      ...
      'Prototyp drucken lassen mit Express 24h funktioniert wenn drei Voraussetzungen passen: CAD ist druckreif, Material ist verfügbar, das Modell ist unter 30 cm Maximalkante. Express 24h kostet 50% Aufpreis auf Standard. Express same-day (Versand am Bestelltag) ist selten möglich und nur für kleine Modelle bis 15 cm und PLA/PETG. Bei Anfragen sehr kurzfristig: rufen Sie an unter +43 676 5517197, ich prüfe Kapazität live. Stammkunden mit DfAM-Beratung (Design for Additive Manufacturing): sorgfältige Pre-Flight-Begleitung der Geometrie für optimale Druck-Tauglichkeit.',
    ],
  },
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'Standard 3-5 Werktage. Express 24-48h gegen 50% Aufpreis machbar. Bei sehr kleinen Modellen unter 15 cm Maximalkante teils auch same-day möglich. Lead-Time abhängig von Material-Verfügbarkeit und aktueller Kapazitäts-Auslastung.',
    },
    {
...
const firmenkunden: ServiceSeoContent = {
  ...
  longTailBody: {
    ...
    paragraphs: [
      ...
      'Mengenrabatt 3D-Druck startet ab 10 Stück mit 5 %. Ab 50 Stück 8 %, ab 100 Stück 10 % Rabatt auf den Listenpreis. Bei Stückzahlen über 500 verlassen wir die Standard-Rabattstaffel und kalkulieren individuell, weil ab da Druckbett-Optimierung und Material-Bulk-Einkauf signifikante Skaleneffekte bringen.',
  ...
  faqs: [
    {
      ...
      answer:
        'Mengenrabatt ab 5 Stück (5%), ab 10 Stück 5 %, ab 50 Stück 8 %, ab 100 Stück 10 %. Zahlungsziel 30 Tage ab dem 2. Auftrag. NDA-fähige Projektabwicklung mit verschlüsseltem Datentransfer. Persönlicher Ansprechpartner direkt zum Inhaber.',
    },
    {
