...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  'wien': {
    ...
    metaTitle: '3D-Druck Wien ★5,0 · Express über Nacht · Angebot in 6h',
    metaDescription: '3D-Druck Anbieter für Wien ✓ Architekturmodelle & Prototypen ✓ Express über Nacht ✓ Angebot in 6h ✓ persönliche Übergabe möglich. ★ 5,0 (35 Bewertungen) | ekdruck',
    heroSubtitle: 'Sie suchen eine zuverlässige 3D-Druck-Firma in Wien? Als spezialisierter Anbieter und Dienstleister fertigen wir Modelle, Prototypen und Designstudien für Wiener Unternehmen, Architekturbüros, Startups, Kreativagenturen und Versicherungs-Kommunikation · mit Express-Lieferung über Nacht. Wiederkehrende Wiener Stamm­kunden in Donaustadt, am Wienerberg und im Quartier rund um das Messe­zentrum Wien Reed Exhibitions vertrauen seit Jahren auf direkte Liefer­zeiten und persönlichen Inhaber-Kontakt.',
    deliveryTime: '5-7 Tage',
    deliveryNote: 'Versand direkt nach Wien, Express über Nacht möglich, persönliche Übergabe in Donaustadt / Innere Stadt auf Wunsch',
    localIndustries: [
      ...
      { name: 'Versicherungs- & Finanzkommunikation', sector: 'Großkunden Innere Stadt & Wienerberg', application: 'Demonstrationsmodelle für Versicherungs-Roadshows, Schaumodelle für Risiko-Visualisierung (anonymisiert: einer der größten österreichischen Versicherer ist seit mehreren Jahren wiederkehrender Auftraggeber)' },
      ...
      { name: 'Messezentrum Wien Reed Exhibitions', sector: 'Aussteller & Eventagenturen', application: 'Messemodelle, Standexponate, Schaumodelle für Industriemessen Donaustadt' },
      { name: 'Kulturwirtschaft', sector: 'Museen & Galerien', application: 'Ausstellungsobjekte, Nachbildungen, Dekorationselemente' },
    ],
    localAdvantages: [
      'Express-Versand nach Wien über Nacht · Lieferung am Folgetag vor 10 Uhr',
      'Erfahrung mit Wiener Großkunden (Versicherungs-Branche, Industrieaussteller im Messezentrum Wien Donaustadt)',
      'Persönliche Übergabe in Wien Innere Stadt / Donaustadt / Wienerberg auf Anfrage',
      'Direkter Inhaber-Kontakt für sensible Projekte (NDA-fähig, kein Subunternehmer)',
  ...
  'linz': {
    ...
    metaDescription: '3D-Druck Anbieter für Linz ✓ Same-Day-Service ✓ Abholung in 20 Min ✓ Modelle & Prototypen ✓ Angebot in 6h. ★ 5,0 (35 Bewertungen) · ekdruck Gunskirchen',
  ...
  'graz': {
    ...
    metaTitle: '3D-Druck Graz ★5,0 · Express via A9 · Angebot in 6h',
    metaDescription: '3D-Druck Anbieter für Graz ✓ Designstudien & Prototypen ✓ Express via A9 ✓ Angebot in 6h ✓ persönliche Beratung. ★ 5,0 (35 Bewertungen) | ekdruck',
  ...
  'salzburg': {
    ...
    h1Title: '3D-Druck Salzburg · Detailtreue über die Westautobahn',
    metaTitle: '3D-Druck Salzburg ★5,0 · A1-Express · Angebot in 6h',
    metaDescription: '3D-Druck Anbieter für Salzburg ✓ Modelle & Prototypen ✓ Express via A1 ✓ Angebot in 6h ✓ ab €20. ★ 5,0 (35 Bewertungen) · ekdruck Österreich',
  ...
  'innsbruck': {
    ...
    metaDescription: '3D-Druck Anbieter für Innsbruck ✓ Studienmodelle & Designstudien ✓ 8 Materialien ✓ Express ✓ Angebot in 6h. ★ 5,0 (35 Bewertungen) | ekdruck',
  ...
  'klagenfurt': {
    ...
    metaTitle: '3D-Druck Klagenfurt ★5,0 · A10-Express · Angebot in 6h',
    metaDescription: '3D-Druck Anbieter für Klagenfurt ✓ Modelle & Prototypen ✓ Lieferung via A10 ✓ Angebot in 6h ✓ ab €20. ★ 5,0 (35 Bewertungen) | ekdruck',
    ...
    localIndustries: [
      ...
      { name: 'Holzverarbeitung', sector: 'Holzindustrie', application: 'Designmodelle, Formteil-Studien, Konzeptvisualisierungen' },
  ...
  'villach': {
    ...
    metaDescription: '3D-Druck Anbieter für Villach: Gehäuse-Designstudien, Sensorik-Schaumodelle und Konzeptmuster ab Stückzahl 1. Express über A10, Angebot in 6h.',
  ...
  'st-poelten': {
    ...
    metaDescription: '3D-Druck Anbieter für St. Pölten: Studienmodelle, Schulungshilfen und Medientechnik-Objekte drucken lassen. A1-Express, Angebot in 6h.',
  ...
  'dornbirn': {
    ...
    h1Title: '3D-Druck Dornbirn · Detailtreue für Vorarlberger Design',
    metaTitle: '3D-Druck Dornbirn · Anbieter für Textil & Lichttechnik-Design',
    metaDescription: '3D-Druck Anbieter für Dornbirn: Garnführungs-Studien, Leuchtenmodelle und Kunststoff-Formteile drucken lassen. Auch Lieferung CH/DE, Angebot in 6h.',
    heroSubtitle: 'Detailgenaue 3D-Druckmodelle für Vorarlberger Unternehmen. Designstudien und Konzeptmodelle für Textiltechnik, Kunststoffdesign und Lichttechnik · Qualität, die zum Ländle passt.',
    deliveryTime: '5-7 Tage',
    deliveryNote: 'Versand über A14 Rheintal Autobahn',
    localIndustries: [
      { name: 'Textilbranche-Modelle', sector: 'Textil & Bekleidung', application: 'Präsentations- und Messemodelle für die Textilbranche, Designstudien, Anschauungsmodelle' },
  ...
  'oberoesterreich': {
    ...
    h1Title: '3D-Druck Oberösterreich · Linz, Wels & Umgebung',
    metaTitle: '3D-Druck Oberösterreich & Linz ★5,0 · heute anfragen, Abholung möglich',
    metaDescription: '3D-Druck für Linz, Wels & ganz OÖ, gefertigt in Gunskirchen: Modelle, Prototypen, Designstudien. Angebot in 6h, Express 24-48h, Abholung 10 Min von Wels. ★5,0 aus 35 Bewertungen.',
    heroSubtitle: 'Ihr lokaler 3D-Druck-Partner für Linz, Wels und ganz Oberösterreich. Persönliche Abholung in Gunskirchen (10 Minuten von Wels, 20 von Linz) oder Express-Lieferung in den gesamten Zentralraum · von der Designstudie bis zur Projektmenge.',
  ...
  'niederoesterreich': {
    ...
    metaDescription: '3D-Druck Anbieter für Niederösterreich: Konzeptmodelle, Schablonen und Weinbau-Zubehör drucken lassen. A1-Lieferung in 5-7 Tagen, Angebot in 6h.',
  ...
  'kaernten': {
    ...
    metaDescription: '3D-Druck Anbieter für Kärnten: Formteil-Studien, Displayobjekte und Gehäusemodelle drucken lassen. Robuster Versand über A10, Angebot in 6h.',
    ...
    localIndustries: [
      ...
      { name: 'Holzindustrie-Modelle', sector: 'Holzverarbeitung', application: 'Formteil-Modelle, Designstudien, Konzeptvisualisierungen' },
  ...
  'vorarlberg': {
    ...
    h1Title: '3D-Druck Vorarlberg · Detailtreue für das Ländle',
    metaTitle: '3D-Druck Vorarlberg · Anbieter für Export-Industrie & Design',
    metaDescription: '3D-Druck Anbieter für Vorarlberg: Architektur- und Messemodelle, Designstudien und Präsentationsmodelle für die Textilbranche drucken lassen. Auch Lieferung in die Schweiz.',
    heroSubtitle: 'Detailgenaue 3D-Druckmodelle für Vorarlberger Unternehmen. Designstudien und Konzeptmodelle für Textiltechnik, Kunststoffdesign und die exportstarke Industrie im Ländle.',
    deliveryTime: '5-7 Tage',
    deliveryNote: 'Versand über A14 Rheintal',
    localIndustries: [
      { name: 'Textilbranche-Modelle', sector: 'Textil & Design', application: 'Messeexponate, Präsentationsmodelle, Designkonzepte' },
