...
export const regionalArchitekturExtendedData: Record<string, RegionalArchitekturExtendedData> = {
  'wien': {
    ...
    faqs: [
      ...
      { question: "Gibt es persönliche Übergabe in Wien?", answer: "Ja, auf Anfrage ist persönliche Übergabe in Wien möglich. Standard sind 3-5 Werktage ab Datenfreigabe, Express in 24h für Wettbewerbstermine." },
  ...
  'steiermark': {
    ...
    faqs: [
      ...
      { question: "Wie wird nach Graz geliefert?", answer: "Versand über die A9 Pyhrnautobahn. Standard 3-5 Werktage ab Datenfreigabe, Express in 24h. Versand mit Tracking und versicherter Lieferung." },
  ...
  'salzburg': {
    ...
    faqs: [
      ...
      { question: "Wie schnell geht die Lieferung nach Salzburg?", answer: "Standard über die A1 Westautobahn: 3-5 Werktage ab Datenfreigabe. Express in 24h möglich. Salzburg liegt verkehrstechnisch günstig · die Lieferung ist schnell und unkompliziert." },
  ...
  'kaernten': {
    ...
    faqs: [
      ...
      { question: "Wie wird nach Kärnten geliefert?", answer: "Versand über A10 Tauernautobahn mit robuster Alpenverpackung. Standard 3-5 Werktage ab Datenfreigabe, Express in 24h für Wettbewerbstermine." }
    ]
  },
  ...
  'niederoesterreich': {
    ...
    faqs: [
      ...
      { question: "Wie schnell kommt ein Modell nach Niederösterreich?", answer: "Über A1/S33 in 3-5 Werktagen ab Datenfreigabe. Express in 24h für Wettbewerbstermine. Nach St. Pölten über A1 besonders schnell." },
  ...
  'burgenland': {
    ...
    faqs: [
      ...
      { question: "Wie wird ins Burgenland geliefert?", answer: "Versand über Wien/A4. Standard 3-5 Werktage ab Datenfreigabe, Express in 24h. Die Nähe zu Wien sorgt für unkomplizierte Logistik." },
